export interface DemoLibRouterParamCodec<O extends {} = {}, P = string, V = any> {
  serialize?: (value: V) => string
  deserialize?: (value: string) => V
}

export type DemoLibRouterParamMapper<O> = Partial<{ [P in keyof O]: DemoLibRouterParamCodec<O, P, O[P]> }>

export const demoLibRouterDefaultCodecs = [
  {
