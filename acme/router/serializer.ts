export interface AcmeRouterParamCodec<O extends {} = {}, P = string, V = any> {
  serialize?: (value: V) => string
  deserialize?: (value: string) => V
}

export type AcmeRouterParamMapper<O> = Partial<{ [P in keyof O]: AcmeRouterParamCodec<O, P, O[P]> }>

export const acmeRouterDefaultCodecs = [
  {
...
export class AcmeRouterSerializer<O> {
  constructor(protected defaults: O, protected mapper?: AcmeRouterParamMapper<O>, protected codecs = acmeRouterDefaultCodecs) {}
