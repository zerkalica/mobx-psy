...
import { DefaultParams, MyRouterRoute } from './Route'
import { MyRouterParamMapper } from './Serializer'
import { defer, LocationLike } from 'mobx-psy'

export interface MyRouterHistory {
...
export class MyRouterLocation {
  ...
  route<O extends DefaultParams>(
    defaults: O,
    mapper?: MyRouterParamMapper<O>,
    deleteDefault = true
  ): MyRouterRoute<O> {
    return new MyRouterRoute(defaults, mapper, deleteDefault, this)
  }
