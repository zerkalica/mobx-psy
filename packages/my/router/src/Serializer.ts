export interface MyRouterParamCodec<O extends {} = {}, P = string, V = any> {
  serialize?: (value: V) => string
  deserialize?: (value: string) => V
}

export type MyRouterParamMapper<O> = Partial<{ [P in keyof O]: MyRouterParamCodec<O, P, O[P]> }>

export const myRouterDefaultCodecs = [
  {
...
export class MyRouterSerializer<O> {
  constructor(
    protected defaults: O,
    protected mapper?: MyRouterParamMapper<O>,
    protected codecs = myRouterDefaultCodecs
  ) {}
