export interface SnapRouterParamCodec<O extends {} = {}, P = string, V = any> {
  serialize?: (value: V) => string
  deserialize?: (value: string) => V
}

export type SnapRouterParamMapper<O> = Partial<{ [P in keyof O]: SnapRouterParamCodec<O, P, O[P]> }>

export const snapRouterDefaultCodecs = [
  {
...
export class SnapRouterSerializer<O> {
  constructor(protected defaults: O, protected mapper?: SnapRouterParamMapper<O>, protected codecs = snapRouterDefaultCodecs) {}
